...
namespace Ginei
{
    ...
    /// 士官（少尉以上）は既存の階級 tier（少尉1〜元帥12・<see cref="RankSystem"/>）に一致＝中尉/中佐を含む完全12段ラダー。
    ...
    public enum MilitaryGrade
    {
        ...
        伍長, 軍曹, 曹長,                  // 下士官
        准尉,                            // 准士官
        少尉, 中尉, 大尉, 少佐, 中佐, 大佐, // 尉官・佐官（士官tier 1-6）
        准将, 少将, 中将, 大将, 上級大将, 元帥 // 将官（士官tier 7-12）
    }
    ...
    public static class RankDistributionRules
    {
        ...
        /// <summary>
        /// 士官グレードを既存の階級 tier（少尉1/中尉2/大尉3/少佐4/中佐5/大佐6/准将7/少将8/中将9/大将10/上級大将11/元帥12）へ写す。
        ...
        public static int ToOfficerTier(MilitaryGrade g)
        {
            switch (g)
            {
                ...
                case MilitaryGrade.中尉: return 2;
                case MilitaryGrade.大尉: return 3;
                case MilitaryGrade.少佐: return 4;
                case MilitaryGrade.中佐: return 5;
                case MilitaryGrade.大佐: return 6;
                case MilitaryGrade.准将: return 7;
                case MilitaryGrade.少将: return 8;
                case MilitaryGrade.中将: return 9;
                case MilitaryGrade.大将: return 10;
                case MilitaryGrade.上級大将: return 11;
                case MilitaryGrade.元帥: return 12;
                default: return 0; // 兵卒〜准尉
            }
        }

        /// <summary>士官 tier（少尉1〜元帥12）に対応する <see cref="MilitaryGrade"/>（<see cref="ToOfficerTier"/> の逆）。
        /// 範囲外は安全側（&lt;1＝准尉／&gt;12＝元帥）。昇進の定員ゲート（その階級に空きがあるか）で使う。</summary>
        public static MilitaryGrade GradeForOfficerTier(int tier)
        {
            switch (tier)
            {
                case 1: return MilitaryGrade.少尉;
                case 2: return MilitaryGrade.中尉;
                case 3: return MilitaryGrade.大尉;
                case 4: return MilitaryGrade.少佐;
                case 5: return MilitaryGrade.中佐;
                case 6: return MilitaryGrade.大佐;
                case 7: return MilitaryGrade.准将;
                case 8: return MilitaryGrade.少将;
                case 9: return MilitaryGrade.中将;
                case 10: return MilitaryGrade.大将;
                case 11: return MilitaryGrade.上級大将;
                case 12: return MilitaryGrade.元帥;
        ...
        /// <paramref name="namedByTier"/>[t] は階級 tier t（少尉1〜元帥12・<see cref="ToOfficerTier"/>）の実在士官数。
