...
- `設定/` … 世界設定の用語ノート（回廊・灯台・環暦・封土・旗幟・諸侯・職分・提督・官僚・商人・陣形・信仰／文化＝語録・祝祭・軍歌・勲章・艦級・食／知識機関＝名門校・諜報機関・正史と稗史・水先案内人／統治軍制＝政体・階級・要塞・稟議／会戦戦略＝士気・練度・通商破壊・兵站／経済＝通貨・金融・商社・財政／外交戦争＝外交・条約・戦争・会戦 ほか）。索引 → [[用語集]]
