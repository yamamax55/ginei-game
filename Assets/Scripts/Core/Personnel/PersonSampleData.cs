...
namespace Ginei
{
    ...
    public static class PersonSampleData
    {
        ...
        public static readonly IReadOnlyList<Person> Leaders = new List<Person>
        {
            ...
            { isSovereign = true, rankTier = 10, leadership = 80, operation = 72, intelligence = 66 },
            new Person(90002, "評議会議長 アルブレヒト", Faction.同盟, PersonRole.文民)
            { isPolitician = true, rankTier = 8, leadership = 62, operation = 74, intelligence = 78 },
            new Person(90003, "国務委員 ヴァルター", Faction.同盟, PersonRole.文民)
            { isPolitician = true, rankTier = 6, leadership = 55, operation = 68, intelligence = 70 },
        };
        ...
        public static readonly IReadOnlyList<Person> Civilians = new List<Person>
        {
            ...
            { rankTier = 7, operation = 82, intelligence = 76, research = 20 },
            new Person(90012, "技術総監 ハイネ", Faction.同盟, PersonRole.文民)
            { rankTier = 6, operation = 40, intelligence = 45, research = 84, engineering = 78, planning = 60, production = 55 },
        };
        ...
        public static readonly IReadOnlyList<Person> Bureaucrats = new List<Person>
        {
            ...
            { rankTier = 5, operation = 64, intelligence = 52, research = 15 },
            new Person(90022, "民部事務官 リンザー", Faction.同盟, PersonRole.文民)
            { rankTier = 4, operation = 58, intelligence = 55 },
        };
