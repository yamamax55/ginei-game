...
> ※完全12段ラダー（少尉1/中尉2/大尉3/少佐4/中佐5/大佐6/准将7/少将8/中将9/大将10/上級大将11/元帥12）へ改番済み。下表は将官（7-12）の指揮規模。

| tier | 階級 | 指揮できる規模（銀英伝準拠） | 梯団の段 | 目安隻数 |
|---|---|---|---|---|
| 7 | 准将 | 分艦隊の一部〜分艦隊 | 分艦隊 | 〜3,000 |
| 8 | 少将 | 分艦隊 | 分艦隊 | 〜6,000 |
| 9 | **中将** | **一個艦隊の司令官になれる下限** | 艦隊 | 〜12,000 |
| 10 | **大将** | 標準的な一個艦隊司令官 | 艦隊 | 〜15,000 |
| 11 | 上級大将（帝国） | 複数艦隊・方面 | 艦隊群/方面 | 〜30,000 |
| 12 | **元帥** | **宇宙艦隊総司令（数個艦隊）** | 宇宙艦隊 | 〜60,000＋ |
