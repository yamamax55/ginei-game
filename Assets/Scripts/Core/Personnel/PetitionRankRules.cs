namespace Ginei
{
    /// <summary>具申の区分（階級ゲートの単位）。低位ほど誰でも、高位ほど将官専用。</summary>
    public enum PetitionCategory { 建白, 予算, 編制, 作戦, 人事, 政治 }
