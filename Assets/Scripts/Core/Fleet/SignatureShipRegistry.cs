    ...
    public static class SignatureShipRegistry
    {
        ...
        private static Dictionary<string, string> BuildDefaults()
        {
            return new Dictionary<string, string>
            {
                ...
                { "ファーレンハイト", "アースグリム" },
                { "アッテンボロー",   "トリグラフ" },
                // 本作オリジナル（主人公候補）。回廊読み＝航海の基準点グリニッジ天文台に因む。
                { "ミレイア・セルウィン", "グリニッジ" },
                { "ミレイア",             "グリニッジ" },
                // ミレイアの同期・親友（元貴族＝フォンを外した）。グリニッジ（標準時）と対の大時鐘ビッグベン。
                { "アウレリア・ファルケンハイト",         "ビッグベン" },
                { "アウレリア・フォン・ファルケンハイト", "ビッグベン" }, // 旧名でも解決
                { "アウレリア",                           "ビッグベン" },
                // 碧晶公国の貴族士官。冷たく美しい秩序の象徴＝壮麗な宮殿ヴェルサイユ。
                { "コンラート・フォン・メーアブルク", "ヴェルサイユ" },
                { "コンラート",                       "ヴェルサイユ" },
            };
        }
